...
import static frc.robot.subsystems.swerve.SwerveConstants.BACK_LEFT_MODULE;
import static frc.robot.subsystems.swerve.SwerveConstants.BACK_RIGHT_MODULE;
import static frc.robot.subsystems.swerve.SwerveConstants.DRIVE_GAINS;
import static frc.robot.subsystems.swerve.SwerveConstants.FRONT_LEFT_MODULE;
import static frc.robot.subsystems.swerve.SwerveConstants.FRONT_RIGHT_MODULE;
import static frc.robot.subsystems.swerve.SwerveConstants.SLIP_CURRENT;
import static frc.robot.subsystems.swerve.SwerveConstants.SPEED_AT_12V;
import static frc.robot.subsystems.swerve.SwerveConstants.STATOR_CURRENT;
import static frc.robot.subsystems.swerve.SwerveConstants.STEER_GAINS;
...
public class SwerveConfig {
  ...
  private static final Slot0Configs steerGains = STEER_GAINS;
  // When using closed-loop control, the drive motor uses the control
  // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
  private static final Slot0Configs driveGains = DRIVE_GAINS;
      ...
      new TalonFXConfiguration()
          .withCurrentLimits(
              new CurrentLimitsConfigs()
                  ...
                  .withStatorCurrentLimit(STATOR_CURRENT)
  ...
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = SPEED_AT_12V;
  ...
  private static final Angle kFrontLeftEncoderOffset = FRONT_LEFT_MODULE.encoderOffset();
  ...
  private static final Angle kFrontRightEncoderOffset = FRONT_RIGHT_MODULE.encoderOffset();
  ...
  private static final Angle kBackLeftEncoderOffset = BACK_LEFT_MODULE.encoderOffset();
  ...
  private static final Angle kBackRightEncoderOffset = BACK_RIGHT_MODULE.encoderOffset();
